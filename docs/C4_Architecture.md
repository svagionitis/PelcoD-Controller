...
C4Container
    ...
    Container(coreLib, "PelcoDCore", "Pure C++17, Zero Qt/Socket/Math", "Core domain library containing protocol framing, command pacing, abstract ITransport port, BusScanner, PatrolController, MacroPlayer, and RttProfiler.")
...
C4Component
    ...
    Container_Boundary(core, "PelcoDCore (Static Library)")
        ...
        Component(status, "DeviceStatus / FujinonStatus", "C++17 Data Structures", "Telemetry state holding coordinates, alarm flags, preset states, and camera optics info.")
