...
### 1. Core Wavelet Engine ([`Dwt.h`](../../libs/PelcoDMath/Dwt.h) & [`Dwt.cpp`](../../libs/PelcoDMath/Dwt.cpp))
...
- **`Math::wavedec` & `Math::waverec`:**
  - Multi-level pyramidal decomposition returning [`WaveletDecomposition1D`](../../libs/PelcoDMath/Dwt.h#L18).
- **`Math::waveletDenoise`:**
...
6. **Related Documentation in This Repository:**  
   ...
   - [`libs/PelcoDMath/Dwt.h`](../../libs/PelcoDMath/Dwt.h): Core C++17 DWT and wavelet shrinkage implementation.
