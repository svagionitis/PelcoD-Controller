...
### 1. Core 1D & 2D FFT Library ([`Fft.h`](../../libs/PelcoDMath/Fft.h) & [`Fft.cpp`](../../libs/PelcoDMath/Fft.cpp))
...
- **`Math::computePsd()`:** Windowed Power Spectral Density calculation with sorted [`SpectralPeak`](../../libs/PelcoDMath/Fft.h#L25) extraction.
- **`Math::fft2D()`:** Separable 2D FFT/IFFT for image processing matrices.

---

### 2. Video Frame Stabilization ([`PhaseCorrelation.h`](../../libs/PelcoDMath/PhaseCorrelation.h))
...
### 4. Sliding Window Spectrograms ([`Stft.h`](../../libs/PelcoDMath/Stft.h))
...
6. **Related Documentation in This Repository:**  
   ...
   - [`libs/PelcoDMath/Fft.h`](../../libs/PelcoDMath/Fft.h): Core C++17 FFT implementation.
   - [`libs/PelcoDMath/PhaseCorrelation.h`](../../libs/PelcoDMath/PhaseCorrelation.h): 2D FFT global motion estimator.
